const services = [
  {
    ...
    details: [
      ...
      },
      {
        ...
        content: `At Green Dermatology, we offer a range of treatments tailored to your skin's unique needs. From prescription-strength topical medications that reduce oil production and inflammation to advanced therapies like phototherapy, which uses UV light to target bacteria and promote healing, we're committed to finding the right solution for you.`
      },
      {
        title: 'Home Care Tips',
        content: `For mild cases, simple changes can make a difference. Practice good skincare habits such as washing your face twice daily with a gentle cleanser, avoiding irritants like harsh cleansers and fragrances, and resisting the urge to pick at pimples, which can worsen inflammation and scarring.`
      },
      {
    ...
    details: [
      ...
      },
      {
        ...
        content: `Excisions are typically performed in-office under local anesthesia to ensure comfort during the procedure. Depending on the type and location of the lesion, different techniques may be employed:
          - Shave excision: For lesions above the skin surface, a small blade is used to remove the growth, often followed by cautery or medication to stop bleeding.
          - Scissor excision: Used for raised lesions, this technique involves snipping around and under the lesion with small, curved scissors.
          - Full skin excision: Recommended for high-risk lesions, this procedure removes the entire affected area along with surrounding tissue to ensure complete removal of abnormal cells. Closure may require stitches or a skin graft.
          - Cryotherapy: In cases such as wart removal or keratoses, liquid nitrogen is applied to freeze and remove the lesion.`
      },
      {
    ...
    details: [
      ...
      },
      {
        ...
        content: `While psoriasis cannot be cured, Dr. Paige Venables offers various treatments to manage symptoms effectively:
          ...
          - UV light therapy (phototherapy) to slow skin cell turnover and alleviate symptoms`
      },
      {
        title: 'Managing Psoriasis',
        content: `The team at Green Dermatology provides personalized care to address your specific psoriasis symptoms and minimize flare-ups. They work closely with you to develop a treatment plan that suits your needs and lifestyle.`
      },
      {
        title: 'Schedule Your Consultation',
