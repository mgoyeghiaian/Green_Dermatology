  ...
  return (
    <div className="bg-bg-main min-h-[85vh] flex flex-col lg:flex-row gap-4 p-5 justify-center items-center">
      <div className="w-full lg:w-1/2 flex justify-center items-center mb-5 lg:mb-0">
        <img src={AboutUSImage} className=" w-[68%] lg:block hidden rounded-sm shadow-lg" alt="About Us" />
      </div>
      <div className="text-left gap-5 w-full lg:w-1/2 p-5 lg:p-0">
        <h1 className="text-3xl font-bold mb-4 text-primary">About Us</h1>
        <p className="mb-4 text-justify">Welcome to Delaware Dermatology, where compassionate care meets expertise. Nestled in the heart of Delaware, our clinic is more than just a medical facility; we&apos;re your second family in the journey towards healthy, radiant skin.</p>
        ...
        <p className="mb-4 text-justify">At Delaware Dermatology, you&apos;re not just another appointment – you&apos;re part of our family. Together, let&apos;s embark on a journey towards healthier, happier skin and a brighter tomorrow.</p>

        <h1 className="text-3xl font-bold mb-4 mt-10 text-primary">Our Physicians</h1>
