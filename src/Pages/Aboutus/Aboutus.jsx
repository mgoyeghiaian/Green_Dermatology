  ...
  return (
    <div className="bg-bg-main min-h-[85vh] flex flex-col lg:flex-row gap-4 p-5 justify-center items-center">
      <Helmet>
        ...
        <meta name="keywords" content="Green Dermatology, dermatology clinic, skin care, Green Dermatology, dermatologists" />
      ...
      <div className="text-left gap-5 w-full lg:w-1/2 p-5 lg:p-0">
        ...
        <p className="text-base sm:text-lg mb-4 text-justify">Welcome to Green Dermatology, where compassionate care meets expertise. Nestled in the heart of Delaware, our clinic is more than just a medical facility; we&apos;re your second family in the journey towards healthy, radiant skin.</p>
        <p className="text-base sm:text-lg mb-4 text-justify">At Green Dermatology, our mission is simple: to provide unparalleled dermatological care tailored to individuals of all ages. Led by a team of board-certified doctors, each member of our staff is dedicated to delivering the highest standard of medical excellence while fostering an environment of warmth and understanding.</p>
