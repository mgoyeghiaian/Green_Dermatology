...
const Afterherobanner = () => {
  ...
  return (
    <div className="min-w-fit min-h-[32vh] flex flex-col lg:flex-row items-center border-y  border-y-black justify-center text-secondary font-medium">
      ...
      <div className="w-full bg-tertiary opacity-80 border-opacity-50 lg:w-[38%] h-[32vh] middle:h-[45vh] p-5 flex flex-col gap-2.5 items-center justify-center text-center lg:pl-[9%] 2xl:pl-[18%] lg:items-start lg:justify-center lg:text-start">
